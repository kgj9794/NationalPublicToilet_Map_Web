...
<nav class="w3-sidebar w3-bar-block w3-card w3-top w3-xlarge w3-animate-left" style="display:none;z-index:2;width:40%;min-width:300px" id="mySidebar">
  ...
  <a href="http://localhost:8080/OSS_Project_8/start.jsp" target="_self" onclick="w3_close()" class="w3-bar-item w3-button 3">초기화면으로➰</a>
  <a href="http://localhost:8080/OSS_Project_8/Ui.jsp" target="_self" onclick="w3_close()" class="w3-bar-item w3-button w3-text-red">화장실 보기🌎</a>
