...
<nav class="w3-sidebar w3-bar-block w3-card w3-top w3-xlarge w3-animate-left" style="display:none;z-index:2;width:40%;min-width:300px" id="mySidebar">
  ...
  <a href="http://localhost:8080/OSS_Project_8/Ver.jsp" onclick="w3_close()" class="w3-bar-item w3-button w3-text-yellow">버전⚡</a>
...
<!-- Top menu -->
<div class="w3-top">
  <div class="w3-yellow w3-animate-top w3-xlarge" style="max-width:100%;margin:auto">
    ...
    <div class="w3-center w3-padding-16 ">버전⚡</div>
  </div>
</div>
